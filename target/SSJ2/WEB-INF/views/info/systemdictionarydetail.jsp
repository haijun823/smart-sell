...
<head>
    <meta charset="UTF-8">
    <title>Title</title>
    <script type="text/javascript" src="/js/utils/systemdictionarydetailutil.js"></script>
</head>
<body>
...
<div id="tools" style="padding:5px;height:auto">
    ...
    <div>
        <form id="search-form">
            ...
            typesId:<input name="typesId" class="easyui-textbox" style="width:200px">
...
<table id="information" class="easyui-datagrid"
       data-options="url:'/systemdictionarydetail/getall',
	                    fitColumns:true,
	                    singleSelect:true,
	                    pagination:true,
	                    fit:true,
    ...
    <tr>
        ...
        <th data-options="field:'types',width:100,align:'center',formatter:typeid">typesId</th>
    </tr>
    </thead>
</table>
...
<div id="addform" class="easyui-dialog" title="添加/修改" style="width: 260px;height: 200px"
    ...
    <form id="editForm" method="post">
        ...
        <table cellpadding="5">
            ...
            <tr>
                <td>类型:</td>
                <td><input id="type" class="easyui-combobox" name="types.id"
                           data-options="valueField:'id',panelHeight:'auto',textField:'name',url:'/systemdictionarytype/getall'" />
